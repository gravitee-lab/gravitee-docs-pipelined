...
After you have link:/am/current/am_quickstart_authenticate_users.html[set up your first application^], you can retrieve user profile information with OpenID Connect.
