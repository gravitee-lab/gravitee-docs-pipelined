...
https://www.mongodb.org/[MongoDB] is the default repository implementation used by AM.
...
NOTE: This is the minimum sample file to start with a MongoDB server. A number of other properties control the behavior of the MongoDB database, as described below.
